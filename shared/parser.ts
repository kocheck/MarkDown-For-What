 ...
 *
 * This is the shared parsing module used by both the Figma and Sketch plugins.
 ...
 * Each block maps to one visual element on the canvas.
 */
...
export function flattenTokens(
    ...
    for (const token of tokens) {
        switch (token.type) {
            ...
            case 'link': {
                // Links render as plain text — URL is not shown in the output.
